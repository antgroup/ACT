...
>
> **资源**: [返回首页](../../README.md) | [TSD Schema](schemas/trust-services-domain/) | [场景示例](../../examples/scenarios/) | [报文示例](../../examples/payloads/)
...
为 ACT 协议生态中的参与方提供争议提交、调解与裁决服务的机构或平台。争议处理接收买卖双方提交的争议申请，依据协议规则与存证证据进行裁决。
...
| `TSD-ATT-DSP`:争议 | 定义争议提交、调解与裁决的交互流程。 |
...
### 4.5 TSD-ATT-DSP：争议处理

#### 概述

争议处理（Dispute Center）为 ACT 协议生态中的参与方提供争议提交、调解与裁决服务。

#### 争议提交

当交易参与方对交易结果存在异议时，可向争议处理提交争议申请。争议申请应包含以下要素：

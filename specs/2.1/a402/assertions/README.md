...
这些断言不是 2.1 消息 Schema。A402 Candidate 的字段分布、状态触发、错误对象和幂等键现在由 [`schemas/a402/`](../schemas/README.md)提供唯一机器源；断言目录只表达测试意图。带有 `pending_decision` 的非 A402 项仍不能成为正式一致性要求。

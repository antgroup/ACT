...
| 时间 | 目标 | 可验证指标 |
|---|---|---|
| 0—1 个月 | 完成 ACT 2.1 Candidate Working Draft 和 Alipay AI Pay Profile Preview 的公开发布 | 法务、安全、公开仓库和发布快照门禁完成；所有公开资产明确标记 Candidate/Preview/Non-normative |
...
| 类型 | 内容 | 当前状态 |
|---|---|---|
| ACT 2.1 Candidate | 支付服务域、A402、商业支付能力协商边界和修订状态 | Candidate Working Draft / Non-normative |
...
| 社区材料 | README、贡献指南、行为准则、治理草案、安全披露说明和 SEP 流程 | 治理和安全渠道待正式确认 |
...
| **同学花名** | **职责** | **GitHub URL** |
|---|---|---|
| 观岳 | ACT 2.1 支付服务域、A402、INS/DEL/AUP、状态机和错误恢复 | 申请前待补充 |
...
截至 2026-08-04，项目处于“内容 Candidate/Preview 已形成，尚未公开发布”的阶段：

- 已以完成版《支付服务域》作为协议事实源，建立 ACT 2.1 PSD Candidate；公开包不再包含 2.0。
...
1. 法务确认版权主体、CC BY 4.0 / Apache 2.0 分配和 CLA 或 DCO 机制；
2. 确认可执行的私密安全报告渠道和责任人；
3. 确认公开 GitHub 仓库、组织归属和发布权限；
4. 形成干净、经评审并通过公开 CI 的发布提交；
5. 正式 TSC/DWG 名单、投票权和对外治理承诺尚未确认。
...
| 法务/开源办公室 | 发布门禁评审 | 版权、许可证、CLA/DCO、商标和第三方依赖 |
...
- [ ] 版权主体、许可证目录分配、CLA 或 DCO 机制；
- [ ] 私密安全报告邮箱/平台、责任人和响应 SLA；

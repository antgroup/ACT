...
> 状态：Profile Preview / Non-normative；Profile 版本：`0.9-preview.1`；产品资料核对：2026-08-08；ACT 兼容版本：ACT Core `2.1-candidate.1`
...
| `integrations/bindings/` | 支付宝产品特定的 Skill/CLI 工作流封装 | [Skill/CLI Binding](bindings/skill-cli/README.md) |
...
- [A402 Candidate / Product Adapter](mappings/a402-candidate-adapter.md)

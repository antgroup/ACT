...
官方安装方式和行为由 [alipay/payment-skills](https://github.com/alipay/payment-skills) 维护。本仓库不复制官方安装文档，只维护 ACT/产品映射和验证入口。可运行入口见 [Agent Payment Quickstart](../../../../../code/examples/alipay/agent-payment/README.md)。

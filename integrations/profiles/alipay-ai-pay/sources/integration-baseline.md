...
这些问题在确认前进入[修订追踪](../../../../governance/revision-status.md)，不能由示例代码自行假设答案。它们默认只阻塞对应的产品能力声明或 `Sandbox Verified`，不阻塞 ACT Candidate 和 Profile Preview；若公开资料足以支持安全下限，Profile 会明确记录该下限。

...
| `method_id` and method version | Used only by the repository's non-normative correlation, replay, and demo artifacts. | They are not added to the Alipay bill, proof, verification, or fulfillment payloads. |

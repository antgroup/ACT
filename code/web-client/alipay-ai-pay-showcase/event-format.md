...
| `method_id`、`method_version` | 所有状态必须保持一致；ID 使用 Candidate 命名空间格式，版本使用 SemVer |
...
| `profile_mapping` | 明确当前事实来自 Product Profile Adapter，而不是支付宝报文中的 Candidate 字段 |

...
const event = {
  ...
  method_version: options["method-version"],
  psp_id: options["psp-id"],
  endpoint_ref: options["endpoint-ref"],
  method_schema_ref: options["method-schema-ref"],
  capability_source_ref: options["capability-source-ref"],
  capability_source_validated: options["capability-source-ref"] ? true : undefined,
  commerce_confirmation_ref: options["commerce-confirmation-ref"],
  request_ref: options["request-ref"],
  request_digest: options["request-digest"],
  request_fingerprint: options["request-fingerprint"],
  http_method: options["http-method"],
  order_ref: options["order-ref"],
  proof_ref: options["proof-ref"],
  transaction_ref: options["transaction-ref"],
  fulfillment_ref: options["fulfillment-ref"],
  delivery_ref: options["delivery-ref"],
  profile_mapping: options["profile-mapping"],
  product_fulfillment_status: options["product-fulfillment-status"],

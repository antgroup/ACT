...
const SIGNALS = Object.freeze({
  ...
  ORDER_CONFIRMED: {
    ...
    observedFrom: "HOST_AGENT",
    required: ["commerce_confirmation_ref"],
  },
  ...
  PAYMENT_SUCCEEDED: {
    ...
    observedFrom: "OFFICIAL_ALIPAY_PAYMENT_SKILL",
    required: ["transaction_ref", "proof_ref"],
  },
  PAYMENT_PENDING: {
...
export function toDemoEvent(input) {
  ...
  if (input.signal === "CAPABILITY_SELECTED" && input.capability_source_validated !== true) {
    throw new Error("CAPABILITY_SELECTED requires capability_source_validated=true");
  }

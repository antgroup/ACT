...
| 级别 | 单命令入口 | 边界 |
|---|---|---|
| 本地 smoke | `npm --prefix quickstarts/alipay/end-to-end-402 run local` | 不支付、不交付付费资源 |
| 买方安装 | `npx -y @alipay/agent-payment@latest install` | 官方安装器继续处理钱包与用户授权 |
| 卖方启动 | `./quickstarts/alipay/metered-rest-provider/run.sh` | 需先完成官网开通并填写 `.env`；脚本测试、构建并启动 |
...
协议与产品关系见 [Alipay AI Pay Profile](../../profiles/alipay-ai-pay/README.md)，分层边界见 [ACT 项目框架](../../docs/architecture/README.md)。

...
> Product content snapshot: 2026-08-03
...
Latest recorded review: [2026-08-03 product update audit](audits/2026-08-03-product-update.md). Prior reviews are the [2026-07-31 product update audit](audits/2026-07-31-product-update.md), [2026-07-28 product update audit](audits/2026-07-28-product-update.md), [2026-07-22 product update audit](audits/2026-07-22-product-update.md) and [2026-07-21 public product fact audit](audits/2026-07-21-product.md).

Latest Skill/CLI review: [2026-07-21 official Skill/CLI behavior audit](audits/2026-07-21-skill-cli.md).

The 2026-08-03 maintenance run rechecked AP-SRC-002—006 and the public onboarding boundary. At the latest verified snapshot:

- the public buyer repository installs with `npx -y @alipay/agent-payment@latest install`;
- the seller integration guide displays update time `2026-07-31 11:54:36` and still defines 402, Base64URL `Payment-Needed`, Base64 `Payment-Proof`, `payment.verify` and `fulfillment.confirm`;
